...
4. Run FedElim-and-periodic-comm-cost-comparison-movielens.py to generate a csv file named FedElim-and-periodic-comm-cost-comparison-movielens.csv.

5. Run FedElim-periodic-comm-total-cost-comparison-movielens.py to generate a csv file named FedElim-periodic-comm-total-cost-comparison-movielens.csv.

6. Feed the csv files in 3-5 above as inputs to plotting-script-movielens.py to generate Figures 3a-3c of the paper.
