...
"""
Plotting script for the synthetic dataset with Gaussian rewards.
"""
...
df = pd.read_csv('total-cost-varying-C.csv')
...
ax.autoscale()
plt.show()
fig.savefig('total-cost-varying-C.pdf', dpi=300)

# # ----------------------------------------------------------------------------------------------------------'

df1 = pd.read_csv('FedElim-and-periodic-comm-cost-comparison.csv')
...
ax.autoscale()
plt.show()
fig.savefig('comm-cost-comparison.pdf', dpi=300)

# ----------------------------------------------------------------------------------------------------------'

width = 0.13
df1 = pd.read_csv('FedElim-and-periodic-comm-total-cost-comparison.csv')
...
fig.set_figheight(40)
plt.show()
fig.savefig('FedElim-vs-periodic-total-cost-comparison.pdf', dpi=300)